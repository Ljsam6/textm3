...
module.exports = function (async, Users, Message, aws, formidable, FriendResult) {
    return {
        SetRouting: function (router) {
            ...
            router.post('/userupload', this.userUpload);//aws.Upload.any(),
        ...
        getProfilePage: function (req, res) {
            async.parallel([
                ...
                res.render('user/profile', { title: 'TextMe - Profile', user: req.user, data: result1, chat: result2 });
            });
        },
        ...
        userUpload: function (req, res) {
            ...
            form.on('end', () => { console.log('file upload sufessfull') });
        ...
        overviewPage: function (req, res) {
            async.parallel([
                ...
                res.render('user/overview', { title: 'Textme - Overview', user: req.user, data: result1, chat: result2 });
            });
        },
